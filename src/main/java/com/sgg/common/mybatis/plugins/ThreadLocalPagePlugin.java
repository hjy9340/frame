package com.sgg.common.mybatis.plugins;

import com.sgg.common.web.Pager;
...
public class ThreadLocalPagePlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (statementId.endsWith("ByPage")){
            ...
            // 获取当前线程分页信息
            Pager<?> pager =  (Pager)parameterHandler.getParameterObject();//ThreadLocalUtil.threadLocal.get();
